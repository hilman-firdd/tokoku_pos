            ...
            <div class="box-header with-border">
                <div class="btn-group">
                    ...
                    <button onclick="deleteSelected('{{ route('produk.delete_selected')}}')"
                        class="btn btn-danger btn-xs btn-flat"><i class="fa fa-trash">
                            Hapus</i></button>
                    <button onclick="cetakBarcode('{{ route('produk.cetak_barcode')}}')"
                        class="m-2 btn btn-info btn-xs btn-flat"><i class="fa fa-barcode">
                            Cetak Barcode</i></button>
                ...
                <form action="" method="post" class="form-produk">
                    ...
                    <table class="table table-stiped table-bordered">
                        <thead>
                            ...
                            <th>Diskon</th>
                            <th>Stok</th>
                            <th><i width="15%" class="fa fa-cog"></i></th>
                        </thead>
                    </table>
                </form>
            </div>
